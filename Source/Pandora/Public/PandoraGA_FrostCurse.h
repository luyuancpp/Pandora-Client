...
#include "PandoraGA_FrostCurse.generated.h"

class UGameplayEffect;

/**
 * Pandora冰咒 (Frost Curse) - 仙道 vs 现代 FPS 反差差异化的核心示例技能.
 *
 * 流程:
 ...
 */
UCLASS()
class PANDORA_API UPandoraGA_FrostCurse : public UGameplayAbility
{
	GENERATED_BODY()

public:
	UPandoraGA_FrostCurse();
	...
	UPROPERTY(EditDefaultsOnly, Category = "Pandora|FrostCurse")
	 ...
	 */
	UPROPERTY(EditDefaultsOnly, Category = "Pandora|FrostCurse|Debug")
