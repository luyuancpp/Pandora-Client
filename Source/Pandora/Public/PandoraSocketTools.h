...
#include "PandoraSocketTools.generated.h"

class USkeletalMesh;

/**
 * Pandora Editor 专用：骨架/Socket 写入工具
 *
 * 为什么需要这个类:
 ...
 */
UCLASS()
class PANDORA_API UPandoraSocketTools : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Pandora|Editor",
