...
#include "PandoraPlayerViewModel.generated.h"
...
class PANDORA_API UPandoraPlayerViewModel : public UMVVMViewModelBase
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "Pandora|HUD")
	float GetHealth() const { return Health; }

	UFUNCTION(BlueprintCallable, Category = "Pandora|HUD")
	...
	UFUNCTION(BlueprintPure, FieldNotify, Category = "Pandora|HUD",
