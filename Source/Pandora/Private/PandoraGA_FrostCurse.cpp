...
#include "PandoraGA_FrostCurse.h"
#include "PandoraCharacter.h"
#include "PandoraFrostEffects.h"
...
UPandoraGA_FrostCurse::UPandoraGA_FrostCurse()
{
...
void UPandoraGA_FrostCurse::ActivateAbility(const FGameplayAbilitySpecHandle Handle,
	...
	const FGameplayEventData* TriggerEventData)
{
	...
	APandoraCharacter* Caster = ActorInfo ? Cast<APandoraCharacter>(ActorInfo->AvatarActor.Get()) : nullptr;
